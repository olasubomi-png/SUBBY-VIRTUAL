...
export function WorkspaceLoading({
  ...
  return (
    <div className="grid min-h-screen place-items-center bg-[#080b09] px-6">
      <div className="flex w-full max-w-sm flex-col items-center text-center">
        <div className="relative flex h-16 w-16 items-center justify-center">
          ...
          />
          <span
            className="brand-spinner absolute inset-0 rounded-full border-2 border-transparent border-t-emerald-500/90 border-r-emerald-400/30"
            aria-hidden
          />
